// @/app/auth/register/register-view.tsx
// The screen itself. page.tsx stays a Server Component so it can turn a
// signed-in visitor away before any of this renders.
"use client";
