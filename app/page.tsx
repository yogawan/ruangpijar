...
export default function HomePage() {
  return (
    <main className="overflow-hidden bg-background text-foreground">
      <header className="border-border/90 border-b bg-background/95">
        <nav
      ...
      >
        <div>
          ...
          <h1 className="max-w-3xl font-display text-5xl leading-[1.06] text-foreground sm:text-6xl">
            Kadang, yang kita butuhkan bukan jawaban.{" "}
            <em className="text-brand">Tapi waktu untuk berhenti.</em>
          </h1>
          <p className="mt-7 max-w-xl text-lg leading-8 text-muted-foreground">
            RuangPijar membantu kamu mencatat kondisi harian, melihat pola yang
            mungkin terlewat, dan menemukan langkah kecil untuk menjaga
          ...
          <p className="mt-5 text-sm text-muted-foreground">
            ...
            <span aria-hidden="true">&#8226;</span> Hanya butuh sekitar 2 menit
          </p>
        </div>
      ...
      <section className="border-y border-border bg-surface" id="tentang">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 lg:py-24">
          ...
          <p className="mt-10 text-lg font-semibold text-brand">
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-5 py-20 sm:px-8 lg:grid-cols-2 lg:items-center lg:py-28">
        ...
        <div className="rounded-2xl bg-brand-subtle p-7 sm:p-9">
          <p className="leading-8 text-muted-foreground">
            RuangPijar mengubah catatan kecil dari keseharianmu menjadi gambaran
            yang lebih mudah dipahami. Dengan check-in sederhana, kamu bisa
            melihat bagaimana mood, energi, stres, tidur, dan aktivitas
      ...
      <section id="cara-kerja" className="bg-peach-subtle">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 lg:py-24">
          ...
          <p className="mt-8 flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-sm font-semibold tracking-wide text-brand">
            <span>Reflect</span>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-5 py-20 sm:px-8 lg:grid-cols-2 lg:items-center lg:py-28">
          <div>
            ...
            <p className="mt-6 leading-8 text-muted-foreground">
              ...
              mencatat, kamu mungkin mulai melihat hubungan antara berbagai hal
              dalam keseharianmu.
            </p>
            <Link
              href="/auth/register"
          ...
          <article className="rounded-2xl bg-brand-subtle p-7 sm:p-9">
            <p className="text-sm font-semibold text-brand">
              Insight minggu ini
            </p>
            ...
            <p className="mt-6 text-xs leading-5 text-muted-foreground">
              Insight ini berasal dari pola check-in selama periode tertentu dan
              bukan merupakan diagnosis kesehatan mental.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-6xl gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:py-28">
        <div className="rounded-2xl bg-sage-soft p-8 sm:p-11">
          <Image
          ...
          <dl className="mt-8 grid gap-5 sm:grid-cols-3">
            ...
            <div>
              <Image
                ...
                className="h-16 w-16 rounded-full object-contain"
              />
              <dt className="mt-3 font-semibold text-brand">Non-diagnostik</dt>
              <dd className="mt-2 text-sm leading-6 text-muted-foreground">
      ...
      <section className="bg-brand">
        <div className="mx-auto max-w-3xl px-5 py-24 text-center text-primary-foreground sm:px-8 lg:py-28">
      ...
      <section className="bg-peach-subtle">
        <div className="mx-auto max-w-6xl px-5 py-20 sm:px-8 lg:py-24">
          <div className="rounded-[28px] border border-border bg-surface px-7 py-14 text-center sm:px-12">
